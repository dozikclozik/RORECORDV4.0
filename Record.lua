...
enter_speed_reverse.Text = "Enter your reverse speed (number)"
...
InfoKey1.Size = UDim2.new(0, 86,0, 33)
InfoKey1.TextColor = BrickColor.new("White")
InfoKey1.Text = "Or press <R>"
InfoKey1.TextScaled = true

local InfoKey2 = Instance.new("TextLabel", screenGui) local uiCorner6 = Instance.new("UICorner", InfoKey2)
...
InfoKey2.Size = UDim2.new(0, 86,0, 33)
InfoKey2.TextColor = BrickColor.new("White")
InfoKey2.Text = "Or press <X>"
InfoKey2.TextScaled = true

local InfoKey3 = Instance.new("TextLabel", screenGui) local uiCorner6 = Instance.new("UICorner", InfoKey3)
...
InfoKey3.Size = UDim2.new(0, 71,0, 31)
